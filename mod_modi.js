					...
					$(document).ready(function() {
						...
						$.get(chrome.extension.getURL("/wortfilter.txt"), function(content) {
							...
							if($("span").hasClass("highlight") && !$("div").hasClass("filter")) {
								$("body").prepend("<div class=\"filter\" style=\"position: fixed; z-index: 10000; background-color: red; padding: 10px; bottom: 0; color: white; font-size: 1.2em; display: none;overflow: auto;width: 100px;top: 0;\"></li></div>")
							}
