if (mail == undefined && hostPathLength == 4) {
	...
	var image = new Image();
	image.src = "data:image/png;base64,";
	
	console.log($("#forumThreadContainer").before(image))
	$.ajax({
	    url : userS,
	    type: "GET",
