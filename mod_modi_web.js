if (mail == undefined && hostPathLength == 4 && area !== "leaderboard") {
	...
	$('.threadPostContentSignature').children('p').css('font-size, 1.0rem');
	$('.threadPostContentSignature').children('p').css('line-height, 1.0rem');
	$('.threadPostContentModified').children('p').css('font-size, 1.0rem');
	$('.threadPostContentModified').children('p').css('line-height, 1.0rem');
